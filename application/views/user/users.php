                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($user->status == 1) { ?>
                                                <a class="text-danger" data-toggle="tooltip" title="Block" href="<?php echo site_url('user/user_change_status/'.encode($user->id).'/2'); ?>"><i class="fa fa-ban"></i></a>
                                            <?php } else { ?>
                                                <a class="text-success" data-toggle="tooltip" title="Activate" href="<?php echo site_url('user/user_change_status/'.encode($user->id).'/1'); ?>"><i class="fa fa-check-circle"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <?php 
